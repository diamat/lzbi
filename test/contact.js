...
ContactModel.prototype.kDataupdate = function () {
    return 'dataupdate:';
};
...
function saveRedis(con_id, callback) {
	...
	var q = ['hmset', this.pContact(con_id), this.kCustomer_id(), this.c_id, this.kFIO(), this.fio, this.kPosition(), this.position, this.kPhones(), this.phones, this.kEmail(), this.email, this.kNote(), this.note, this.kDataupdate(), this.dataupdate];
...
function selectRedis (con_id, callback){
	var thism = this;
	var q = [this.pContact(con_id), this.kCustomer_id(), this.kFIO(), this.kPosition(), this.kPhones(), this.kEmail(), this.kNote(), this.kDataupdate()];
