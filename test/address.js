...
AddressModel.prototype.kDataupdate = function () {
    return 'dataupdate:';
};
...
function saveRedis(c_id, type, callback) {
	...
	this.house, this.kOffice(), this.office, this.kNote(), this.note, this.kDataupdate(), this.dataupdate];
...
function selectRedis (c_id, type, callback){
	...
	var qp = this.pUAddress(c_id);
	if(type === 'f') qp = this.pFAddress(c_id);
	var q = [qp, this.kIndex(), this.kCity(), this.kStreet(), this.kHouse(), this.kOffice(), this.kNote(), this.kDataupdate()];
